...
Deployed via **GitHub Pages** through `.github/workflows/hugo.yml` (push to `main` triggers build).
...
| Mobile menu | Hamburger sidebar overlay with aria-expanded |
...
| Resource card movement | Moves cards from main content into mobile header bar |
...
| `assets/css/custom.css` | All custom CSS (~1400 lines) |
...
- **Responsive breakpoint** — Mobile-first design, primary breakpoint at 768px. Resource cards use 3×2 grid on mobile.
